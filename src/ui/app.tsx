...
export function App() {
    ...
    const [hideL2DepositAddress, setHideL2DepositAddress] = useState<boolean>(true);
    ...
    return (
        <div>
            ...
            <fieldset>
                Scores contract address: <b>{CONFIG.CONSTANTS.SCORES_CONTRACT_ADDRESS}</b>
            ...
            <h1>Game details</h1>
            <fieldset>
                During 10 seconds, you have to press the displayed letter, which will increment you <b>score</b>.
                The game ends if you press the wrong letter. The, you can save you <b>score</b> on the blockchain.
            </fieldset>
